...
const AMP_CRATES: &[&str] = &[
    ...
    "amp_client",
    "amp_config",
    "amp_controller_admin_datasets",
    "amp_controller_admin_jobs",
    "amp_controller_admin_providers",
    ...
    "amp_job_core",
    "amp_job_gc",
    "amp_job_materialize_datasets_derived",
    "amp_job_materialize_datasets_raw",
    "amp_object_store",
    "amp_parquet",
    "amp_providers_bitcoin_rpc",
    "amp_providers_common",
    "amp_providers_evm_rpc",
