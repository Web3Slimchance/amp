...
pub use datasets_raw::{
    dataset_kind::{BitcoinRpcDatasetKind, BitcoinRpcDatasetKindError},
    manifest::{BitcoinRpcManifest as Manifest, Table},
};

/// Convert a Bitcoin RPC manifest into a logical dataset representation.
///
