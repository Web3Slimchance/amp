//! Distributed worker service for executing scheduled materialization jobs.
//!
...
//! via `PostgreSQL` LISTEN/NOTIFY, executes assigned materialization jobs, updates job status and progress in
