...
- User asks about code patterns -> Use `/code-discovery` skill
...
4. Suggest using `/code-discovery` or asking for clarification
...
2. **Check patterns** - Use `/code-discovery` for implementation details
